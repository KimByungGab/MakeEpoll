...
public:
    ...
    virtual void OnConnect(const int clientIndex, string ip) = 0;
...
protected:
    void PushSendData(const int clientIndex, char* buffer, int bufferSize);
